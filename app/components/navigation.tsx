...
return (
    <nav className="
      ...
      top-0 left-0  
      bg-secondary
      h-full w-56 flex flex-col px-5 pt-8
      lg-pc:w-120 lg-pc:pt-16
      mobile:w-full mobile:h-20 mobile:p-4 mobile:flex-row mobile:justify-between
      z-50">

      <div className='w-full flex flex-row justify-between pc:hidden'>
      <div className='flex flex-row pc:hidden'>
        ...
        <div className="flex w-full flex-col h-full mobile:hidden">
          <div className="flex-grow ">
            <li className="flex flex-col text-center justify-center"> 
              <div className='font-bold text-2xl lg-pc:text-5xl'> Jaden Wong </div>
              <div className="text-muted-foreground text-xl lg-pc:text-4xl"> Software Engineer</div>
            </li>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 lg-pc:size-12">
              ...
              <Link href="#about" scroll={true} className="font-bold text-xl lg-pc:text-4xl pl-1 ">
                About Me
              </Link>
            </li>
            {/* <li className="flex flex-row items-center py-1 pl-1 my-2 rounded-md hover:bg-muted 
            ...
            lg-pc:py-4 lg-pc:pl-8 ">
              ...
              <Link href="#experience" scroll={true} className="font-bold text-xl lg-pc:text-4xl pl-1">
                Experience
              </Link>
            </li>
            <li className="flex flex-row items-center py-1 pl-1 my-2 rounded-md hover:bg-muted 
            lg-pc:py-4 lg-pc:pl-8 ">
              ...
              <Link href="#projects" scroll={true} className="font-bold text-xl lg-pc:text-4xl pl-1">
                Projects
              </Link>
            </li>
            <li className="flex flex-row items-center py-1 pl-1 my-2 rounded-md hover:bg-muted  
            lg-pc:py-4 lg-pc:pl-8 ">
              ...
              <Link href="#hobbies" scroll={true} className="font-bold text-xl lg-pc:text-4xl pl-1">
                Hobbies
              </Link>
            </li>
            <li className="flex flex-row items-center py-1 pl-1 my-2 rounded-md hover:bg-muted 
             lg-pc:py-4 lg-pc:pl-8 ">
              ...
              <Link href="#contact" scroll={true} className="font-bold text-xl lg-pc:text-4xl pl-1">
                Contact
              </Link>
            </li>
          </div>
