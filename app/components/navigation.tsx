...
export default function Navigation() {
  ...
  return (
    <nav className="
      ...
      sm:h-full sm:w-56 sm:flex-col sm:space-y-4 sm:space-x-0 sm:px-5
      z-50 bg-background
    ">
      {isMobile ? (
        <>
        ...
        <div className="flex w-full flex-col h-full">
          <div className="flex-grow">
            <li className="flex flex-col text-center justify-center"> 
              <div className='font-bold text-2xl'> Jaden Wong </div>
              <div className="text-muted-foreground text-xl"> Software Engineer</div>
            </li>
            <Image
                src={me}
                width={200}
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
              ...
              <Link href="#about" scroll={true} className="font-bold text-xl pl-1 ">
                About Me
              </Link>
            </li>
            <li className="flex flex-row items-center py-1 pl-1 my-2 rounded-md hover:bg-muted ">
              ...
              <Link href="#resume" scroll={true} className="font-bold text-xl pl-1">
                Resume
              </Link>
            </li>
            <li className="flex flex-row items-center py-1 pl-1 my-2 rounded-md hover:bg-muted ">
              ...
              <Link href="#experience" scroll={true} className="font-bold text-xl pl-1">
                Experience
              </Link>
            </li>
            <li className="flex flex-row items-center py-1 pl-1 my-2 rounded-md hover:bg-muted ">
              ...
              <Link href="#projects" scroll={true} className="font-bold text-xl pl-1">
                Projects
              </Link>
            </li>
            <li className="flex flex-row items-center py-1 pl-1 my-2 rounded-md hover:bg-muted  ">
              ...
              <Link href="#hobbies" scroll={true} className="font-bold text-xl pl-1">
                Hobbies
              </Link>
            </li>
            <li className="flex flex-row items-center py-1 pl-1 my-2 rounded-md hover:bg-muted ">
              ...
              <Link href="#contact" scroll={true} className="font-bold text-xl pl-1">
                Contact
              </Link>
            </li>
          </div>
          ...
          <div className="flex flex-row items-center justify-between mt-auto pb-2">
            <div className="flex flex-row items-center">
              ...
              <svg  pointerEvents={undefined} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="45" height="45" viewBox="0 0 30 30">
