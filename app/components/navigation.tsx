...
export default function Navigation() {
  return (
    <nav className="bg-secondary fixed left-0 top-0 z-50 flex h-full w-60 flex-col px-5 pt-8 lg-pc:w-96 lg-pc:pt-8 mobile:h-20 mobile:w-full mobile:flex-row mobile:justify-between mobile:p-4">
      ...
      <div className="flex h-full w-full flex-col mobile:hidden">
        <div className="flex-grow">
          ...
          <Link href="#about" scroll={true}>
            <li className="hover:bg-accent hover:text-accent-foreground my-2 flex cursor-pointer flex-row items-center rounded-md py-1 pl-1 lg-pc:py-2 lg-pc:pl-8">
              <svg
              ...
              <span className="pl-1 text-xl font-bold lg-pc:text-4xl">
                About Me
              </span>
            </li>
          </Link>
