...
export default function Experience() {
    return (
        <div id="experience" className="scroll-mt-4 pb-20 text-lg text-foreground flex flex-row      
        mobile:flex-col mobile:scroll-mt-20">
            <div className='pr-6 w-6/12 mobile:w-full'>
                ...
                <ol className="relative border-s border-color">                  
                    <li className="mb-5 ms-4">
                        ...
                        <time className="mb-1 text-sm font-normal leading-none text-muted-foreground">May 2020 - Aug 2024</time>
                        <h3 className="text-lg font-semibold">Computer Science @Stony Brook University</h3>
                ...
                <ol className="relative border-s border-color">                  
                    <li className="mb-5 ms-4">
                        <div className="absolute w-3 h-3 bg-secondary  rounded-full mt-1.5 -start-1.5 border-color ring-ring"></div>
                        <time className="mb-1 text-sm font-normal leading-none text-muted-foreground">May 2024 - Aug 2024</time>
                        <h3 className="text-lg font-semibold">Software Engineer Intern @Develop For Good</h3>
                        <p className="mb-4 text-muted-foreground font-normal ">
                    ...
                    <li className="mb-5 ms-4">
                        <div className="absolute w-3 h-3 bg-secondary  rounded-full mt-1.5 -start-1.5 border-color ring-ring"></div>
                        <time className="mb-1 text-sm font-normal leading-none text-muted-foreground">Jul 2023 - Aug 2023</time>
                        <h3 className="text-lg font-semibold">Special Initiatives Unit Intern @NYC Department for the Aging</h3>
                        <p className="mb-4 text-muted-foreground font-normal ">
                    ...
                    <li className="ms-4">
                        <div className="absolute w-3 h-3 bg-secondary  rounded-full mt-1.5 -start-1.5 border-color ring-ring"></div>
                        <time className="mb-1 text-sm font-normal leading-none text-muted-foreground">Jun 2022 - Aug 2022</time>
                        <h3 className="text-lg font-semibold">Network Operations Intern @Spotify</h3>
                        <p className="mb-4 text-muted-foreground font-normal ">
