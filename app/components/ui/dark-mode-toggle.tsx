  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end">
        <DropdownMenuItem
          className="lg-pc:h-12 lg-pc:w-40 lg-pc:rounded-2xl lg-pc:text-3xl"
