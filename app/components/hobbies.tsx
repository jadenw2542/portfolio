            ...
            <div>
                ...
                <div className="grid grid-cols-4 mobile:grid-cols-2 gap-4">
                    <div className="grid gap-4">
                        <a href="https://www.amazon.com/Breville-BES840XL-Infuser-Espresso-Machine/dp/B0089SSOR6/ref=sr_1_1?crid=HNBDMY4GLJRX&dib=eyJ2IjoiMSJ9.CO_vhhleRJah1TxqGxJrHxbkThCRFwbEsq5Jw86__NQOX_8pAFV6cF7BbEQ9QAHDJ0vjnbCG6FZrhZAwDmd1h6GPnqHOe6Et8iB4hfTitfYYuu8YRgj-cZ4S2Nzl_qDbuXeP4dXdrdMjsQsUZ60H7QoRmludgMaMSKCOIJKfT6UXzDuV_ldyR0N03mp2r_znZiOxwNyL4d0B_HO0foU6Y_77STBqgZS9ilvnO-33Pa-LY9KAohPWJt-U5xPv5-naLOXtLykqKeInnf8nxJ2XG0U5pUssc5E5CCUezxe1W9c.CexWFc4VpYMaH8xHsAR396H_cRIH1cjP-j8N-r0b50g&dib_tag=se&keywords=breville%2Binfuser&qid=1726126556&sprefix=breville%2Binfus%2Caps%2C329&sr=8-1&th=1"
                        target="_blank"
                        className='rounded-lg bg-card lg-pc:rounded-2xl ring-ring hover:bg-muted h-auto max-w-full object-cover object-center'>
                            <div className='flex flex-col p-4 items-center'>
                                    <Image 
                                    src={Breville}
                                    alt="Breville"
                                    className='max-h-40 mobile:max-h-20 lg-pc:max-h-80 object-contain items-center' 
                                />
                                <div className='font-bold text-xl pt-4 text-center w-full'>Breville Infuser</div>
                                <div className='text-center w-full'>Espresso Machine</div>
                            </div>
                        </a>

                        <a href="https://www.amazon.com/Normcore-58mm-Magnetic-Dosing-Funnel/dp/B0BLW6SKHL/ref=sr_1_2?crid=2PJCJYZIAKYDO&dib=eyJ2IjoiMSJ9.zdGUokKlqvRuYNbR1_EL7BuGT8lY9cTk4aZSNFGPcPRlKrhbePCxyBMXgRbikRjyn1dbZz1l1eUbBBao9Iq4IIP2VC4AJNYh2LuUyhnK0YquFenWwitgj1_-noAKNrYYRye9QerWknZg0kexTQXu7ECUMfiQPkj_WChatlVJhdaT522uzO5f0Xn6vRLZqIfsRF9NuIFcMpH_TaUcw3PYcz5NWkvWhRYXzVD73-KqDEdy8ASSMH4A6ntZioFiqrOTqVk7Hzm9kmIngViKvsskpqDvMh_-h_Ss35lWFUFurYs.b8lChUBwE0l9CZv9Rm-QUR5ORAYsLLFTCYcYIN2cQbM&dib_tag=se&keywords=nomcore%2B54%2Bdosing%2Bfunnel&qid=1726129649&sprefix=nomcore%2B54%2Bdosing%2Bfunn%2Caps%2C256&sr=8-2&th=1"
                        target="_blank"
                        className='rounded-lg bg-card lg-pc:rounded-2xl ring-ring hover:bg-muted h-auto max-w-full object-cover object-center'>
                            <div className='flex flex-col p-4 items-center'>
                                    <Image 
                                    ...
                                    className='max-h-40 mobile:max-h-20 lg-pc:max-h-80 object-contain items-center' 
                                />
                                <div className='font-bold text-xl pt-4 text-center w-full'>Normcore 58mm Magnetic Dosing Funnel V2</div>
                                <div className='text-center w-full'>Dosing Funnel</div>
                            </div>
                        </a>

                        <a href="https://www.amazon.com/CHWARES-Kitchen-Function-Digital-Dieting/dp/B0BWRY75H9/ref=sr_1_6?crid=1QRBV4HPO2LV2&dib=eyJ2IjoiMSJ9.h688GNX6ELHyzJQzDPQQjhpCZMewkTXpsnUai1hrPQu7kyRolldqOp7hjLYjxXqbPAI7Lphwzg3O4CX9MkDtBbDTiUapijeyp9X7ct-t3IXdbo8XoRvL2Y8tMaQQskFEs54AkkpkglP7rXrnGLYvp4xFZHnIC7TvMScfWBDyP3fGg-mTA-8897bWVNj9ECCFHXUM-02cKMf5dk5LVbsmgKZVcpMqIKsWZJG8rOISs8T4D5ZUi9cAQZd8XbJoqjhQVte_JSPN6N_sie-LFQ_OYYQskaZ4LCxKMgTx5hBmM5s.Z4J2ugQZYYh_i5ZyMbQpkQshK99tsScHNIxXNqQm94Q&dib_tag=se&keywords=food+scale+chwares+rechargeable&qid=1726129969&sprefix=food+scale+chwares+rechargab%2Caps%2C238&sr=8-6"
                        target="_blank"
                        className='rounded-lg bg-card lg-pc:rounded-2xl ring-ring hover:bg-muted h-auto max-w-full object-cover object-center'>
                            <div className='flex flex-col p-4 items-center'>
                                    <Image 
                                    ...
                                    className='max-h-40 mobile:max-h-20 lg-pc:max-h-80 object-contain items-center' 
                                />
                                <div className='font-bold text-xl pt-4 text-center w-full'>CHWARES Food Scale</div>
                                <div className='text-center w-full'>Scale</div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div className="grid gap-4">
                    <a href="https://www.amazon.com/MiiCoffee-DF54-Single-Coffee-Grinder/dp/B0D1NMR67G"
                        target="_blank"
                        className='rounded-lg bg-card lg-pc:rounded-2xl ring-ring hover:bg-muted h-auto max-w-full object-cover object-center'>
                            <div className='flex flex-col p-4 items-center'>
                                    <Image 
                                    ...
                                    className='max-h-40 mobile:max-h-20 lg-pc:max-h-80 object-contain items-center' 
                                />
                                <div className='font-bold text-xl pt-4 text-center w-full'>D54</div>
                                <div className='text-center w-full'>Grinder</div>
                            </div>
                    </a>

                    <a href="https://www.amazon.com/IKAPE-Organizer-Distributor-Portafilter-Accessories/dp/B0C492RPFD/ref=sr_1_5?crid=12OSK86XK14HW&dib=eyJ2IjoiMSJ9.pMNLKqbEoP5Ko2VDAFVEe5xOa4Rd2ovRWqlaQ01Gw_C0A5BSziooCRghBLtpU4L2E7vW6zhIx4OdEBHIVUSXsB6U-RL3qRaeSz7HtG7YvvcZOR_8acG2D5A7nNsn0CzZQximtLrx6QDyHRkvixrx4IBOnQx6DCu8rU6JzjcqfIqQEtO4huOUgm26qgcpfUAmNaj5ey_zutGWEqALqZy5FdXICCfnSN1y6Wo4gckv4IQGPPQfVvq276koCIxRXYLIpbb5rrfCyOJSen28vaElgwg1koKnKwM4D3JhDuDd5wM.vSyvGSJRrwo65BMbf_YezFsrCBIw8sFQjCG0HuSSKOI&dib_tag=se&keywords=ikape%2Btamper%2Bstation&qid=1726129582&sprefix=Ikape%2Caps%2C267&sr=8-5&th=1"
                        target="_blank"
                        className='rounded-lg bg-card lg-pc:rounded-2xl ring-ring hover:bg-muted h-auto max-w-full object-cover object-center'>
                            <div className='flex flex-col p-4 items-center'>
                                    <Image 
                                    ...
                                    className='max-h-40 mobile:max-h-20 lg-pc:max-h-80 object-contain items-center' 
                                />
                                <div className='font-bold text-xl pt-4 text-center w-full'>IKAPE Espresso Knock Box</div>
                                <div className='text-center w-full'>Espresso Coffee Organizer Box</div>
                            </div>
                    </a>
                    <a href=""
                        target="_blank"
                        className='rounded-lg bg-card lg-pc:rounded-2xl ring-ring hover:bg-muted h-auto max-w-full object-cover object-center'>
                            <div className='flex flex-col p-4 items-center'>
                                    ...
                                    className='max-h-40 mobile:max-h-20 lg-pc:max-h-80 object-contain items-center' 
                                />
                                <div className='font-bold text-xl pt-4 text-center w-full'>MF02 Rechargeable Milk Frother Handheld Foam Maker</div>
                                <div className='text-center w-full'>Frother</div>
                            </div>
                    </a>
                    </div>
                    ...
                    <div className="grid gap-4">    
                        <a href="https://www.amazon.com/Espresso-Distribution-Stainless-Installed-Replacement/dp/B0BH8MRB2Z/ref=sr_1_6?crid=3G882IPZS6XLC&dib=eyJ2IjoiMSJ9.OHOquaT17mzFfUJtxtmu_0rEvxsygyU9czlrvafFXKS2yU9mX9zBVTzddZ2pK-EaWfps8Thd1mfz6UG3zaZtVI6q_odVxkU7AdUNywgeartTw4a4K4CedYuMgWNtg8vG8DKN8aJxxlwh8ywdfZoCU8FbNPu2Sigo6MS9JwKG1TfFl_EiP-3Lf0CtBq__58H3Ygg7_kw_yuWFGoIrUuIBaDfwD-HA4o0pVDgt8FIDr4n9nCAVBIl7l5oeXfqasvWVG3JJblgKpJdysWxS8AcjFa8hAizzsI99ixtl47EjHAY.c7GZd1TMDunFNaLm2rpYhpbw0M4YZiqD53Zx3jmrGI8&dib_tag=se&keywords=wdt%2Btool&qid=1726129170&sprefix=wdt%2Bto%2Caps%2C380&sr=8-6&th=1"
                        target="_blank"
                        className='rounded-lg bg-card lg-pc:rounded-2xl ring-ring hover:bg-muted h-auto max-w-full object-cover object-center'>
                            <div className='flex flex-col p-4 items-center'>
                                    <Image 
                                    ...
                                    className='max-h-40 mobile:max-h-20 lg-pc:max-h-80 object-contain items-center' 
                                />
                                <div className='font-bold text-xl pt-4 text-center w-full'>WISSXOER WDT Tool</div>
                                <div className='text-center w-full'>WDT Tool</div>
                            </div>
                        </a>

                        <a href="https://www.amazon.com/Normcore-58-5mm-Espresso-Portafilter-Contact/dp/B09DDC7KMQ/ref=sr_1_3?crid=2JPML0XVIXK88&dib=eyJ2IjoiMSJ9.FMeNj50No2L0NfoHKGDrmAE7fY0lGZXHsMHu7qiHbiJtKU60XjsnG7cW8lsEydeiEw0Z4qRcWMjFG_jVCsOrRIEaqU6nbxFVFW0TP_rgZ-jCVEmR9Sr-DNdZI7O9t5AcWJPnaxPNE8_ctaY7YjL0PxXDyo2ms1H8pXbXDNKLc3jZmCjuIblW5GcwJOMDVGkyg2mPgiHeDjlJvTxsQ3Ph_SYda7Ae1G6UZvBLP94BsW1R1ENp5CJolJPbSjrj2QBuXn66XqlZ4zA1AQvxa_jo__l0coY13LkSh-0bZzQD8dg.4oc01wf9Krc_iVcBwQFxgl4mAuZ7Df4dN0MhWXW8Y6I&dib_tag=se&keywords=nomcore+puck+screen&qid=1726129707&sprefix=nomcore+p%2Caps%2C247&sr=8-3"
                        target="_blank"
                        className='rounded-lg bg-card lg-pc:rounded-2xl ring-ring hover:bg-muted h-auto max-w-full object-cover object-center'>
                            <div className='flex flex-col p-4 items-center'>
                                    <Image 
                                    ...
                                    className='max-h-40 mobile:max-h-20 lg-pc:max-h-80 object-contain items-center' 
                                />
                                <div className='font-bold text-xl pt-4 text-center w-full'>Normcore 58.5mm Puck Screen</div>
                                <div className='text-center w-full'>Puck Screen</div>
                            </div>
                        </a>
                        <a href="https://www.amazon.com/Urnex-Espresso-Machine-Cleaner-Tablets/dp/B001VEFXRO"
                        target="_blank"
                        className='rounded-lg bg-card lg-pc:rounded-2xl ring-ring hover:bg-muted h-auto max-w-full object-cover object-center'>
                            <div className='flex flex-col p-4 items-center'>
                                    <Image 
                                    ...
                                    className='max-h-40 mobile:max-h-20 lg-pc:max-h-80 object-contain items-center' 
                                />
                                <div className='font-bold text-xl pt-4 text-center w-full'>Urnex Cafiza</div>
                                <div className='text-center w-full'>Espresso Machine Cleaning Tablets</div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div className="grid gap-4">
                    <a href="https://www.amazon.com/Normcore-58-5mm-Coffee-Tamper-Spring-loaded/dp/B09BTLP4P1/ref=sr_1_1?crid=2GRJ98RHLWEK9&dib=eyJ2IjoiMSJ9.5ejPnTRsrxiwEuiBitw1Ory_SZd5lF5iLSR5Ji0zmMhXu3F-89r_GCQ42o4oprSTqjCWZy_yKZurTzg6Jj4FdvgPgYk7w4PffJBS9iJ4UYudH7GvJ4w8G8z-ExcmzJzeOMNwWfW7CsS12YhbmqVDWq4eP9LbivqPBursKTokbzFIL9NR4OUcgN4Ib4v81LqWosoc3-AUfNMboJhWQN_w8Lylmr6XPgJQC_m35btTd1ogVaQPXhYtKhqKCgq5NHIzpPzdSk24qrYoUulzEydorHslIIjPNhWUeBE4dE2PtaI.S6v2cVigl3-Bn1SLK5syNQgEFNztTcS-ckQP2af1ju0&dib_tag=se&keywords=nomcore&qid=1726129492&sprefix=nomc%2Caps%2C364&sr=8-1"
                        target="_blank"
                        className='rounded-lg bg-card lg-pc:rounded-2xl ring-ring hover:bg-muted h-auto max-w-full object-cover object-center'>
                            <div className='flex flex-col p-4 items-center'>
                                    <Image 
                                    ...
                                    className='max-h-40 mobile:max-h-20 lg-pc:max-h-80 object-contain items-center' 
                                />
                                <div className='font-bold text-xl pt-4 text-center w-full'>Normcore 58.5mm Coffee Tamper V4</div>
                                <div className='text-center w-full'>Coffee Tamper</div>
                            </div>
                        </a>

                        <a href="https://www.amazon.com/MHW-3BOMBER-Blaster-Grinder-Air-move-Cleaning/dp/B09MMV86MZ/ref=sr_1_3?crid=RAU4P8DONB2F&dib=eyJ2IjoiMSJ9.dPcMY9LddiHE081uLrmUPphyPpgGFiLVXBREbU8XihJKT9W5tWAdOyXUOttZgp8HW_L2FpCUoFmW9GG1v6FwWoZUTyDJ4ejloD4dFnjidMRiU3jTqBuUVGYC6z7Hyf-wvKyz7STwtgo0PBJuXMMF-1Lw_YZkGJYDr7LiI8lZVBbOXCfff4eDtqv__j53Uh6G8le4KqfFLofLkCRxVYg2iqkujpWjIsiDKLWcXUbSGY__aJ7XJAx37FsPHfLxdg8SgOggfqhS3Euj1WrMgMMfSPQhzKznTs7FGkEW3yKykQc.K-mlWoEsPTxPZFAjjNW8cEUxNeT2VdbWcjeTs5mUoFs&dib_tag=se&keywords=coffee%2Bblower&qid=1726129799&sprefix=coffee%2Bblowe%2Caps%2C261&sr=8-3&th=1"
                        target="_blank"
                        className='rounded-lg bg-card lg-pc:rounded-2xl ring-ring hover:bg-muted h-auto max-w-full object-cover object-center'>
                            <div className='flex flex-col p-4 items-center'>
                                    <Image 
                                    ...
                                    className='max-h-40 mobile:max-h-20 lg-pc:max-h-80 object-contain items-center' 
                                />
                                <div className='font-bold text-xl pt-4 text-center w-full'>MHW-3BOMBER</div>
                                <div className='text-center w-full'>Coffee Grounds Blower</div>
                            </div>
                        </a>
                        <a href="https://www.amazon.com/AmazonBasics-CW190423-24-Pack-Microfiber-Cleaning/dp/B009FUF6DM"
                        target="_blank"
                        className='rounded-lg bg-card lg-pc:rounded-2xl ring-ring hover:bg-muted h-auto max-w-full object-cover object-center'>
                            <div className='flex flex-col p-4 items-center'>
                                    <Image 
                                    ...
                                    className='max-h-40 mobile:max-h-20 lg-pc:max-h-80 object-contain items-center' 
                                />
                                <div className='font-bold text-xl pt-4 text-center w-full'>Amazon Basics Microfiber Cleaning Cloths</div>
                                <div className='text-center w-full'>Microfiber Cloth</div>
                            </div>
                        </a>
                    </div>
