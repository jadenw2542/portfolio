...
export default function Projects() {
  ...
  return (
    ...
    >
      <h1 className="pb-8 text-3xl font-bold lg-pc:text-5xl">My Projects</h1>

      <div className="bg-card mb-8 flex flex-row rounded-xl lg-pc:mb-14 lg-pc:text-3xl mobile:flex-col-reverse">
        <div className="m-6 flex flex-col pr-4 lg-pc:m-12">
          <div className="flex flex-row items-center justify-between pb-2 lg-pc:pb-3">
            <div className="flex w-full flex-row items-center pr-8">
              <Image
                src={Geowizlogo}
                alt="GeoWizard Logo"
                className="h-10 w-10 lg-pc:h-20 lg-pc:w-20"
              />
              <h1 className="pl-2 text-2xl font-bold lg-pc:pl-6 lg-pc:text-5xl">
                GeoWizard
              </h1>
            </div>

            <a
              href="https://github.com/jadenw2542/GeoWizard"
              target="_blank"
              className="pr-4"
            >
              <Image
                src={GithubIcon}
                alt="Github Link"
                className="h-6 w-7 lg-pc:h-12 lg-pc:w-14"
              />
            </a>
          </div>
          ...
          <h1 className="pb-2 pt-6 text-xl font-bold lg-pc:pb-3 lg-pc:text-4xl">
            Major Features
          </h1>
          <ul className="text-card-foreground list-disc pl-5">
            <li>
              Importing of GeoJson, Keyhole Markup Language, and Shapefiles
            </li>
            ...
            <li>
              Map Graphic Editing&#40;Heapmap, point/locator, Symbol Map,
              Choropleth Map, Flow Map&#41;
            </li>
          </ul>
          <h1 className="pb-2 pt-4 text-xl font-bold lg-pc:hidden lg-pc:pb-3 lg-pc:pt-6 lg-pc:text-4xl pc:hidden">
            Technologies Used
          </h1>
          <span className="flex flex-wrap lg-pc:hidden pc:hidden">
            <Shield
              svg={ReactIcon}
              text="React"
              textColor="#000000"
        ...
        <div className="m-6 flex h-full w-6/12 flex-col mobile:m-0 mobile:w-full">
          <Carousel className="h-full w-full">
            ...
            <CarouselPrevious className="bg-primary bg-secondary hover:bg-muted absolute left-5 top-1/2 z-10 -translate-y-1/2 transform rounded-full p-2" />
            <CarouselNext className="bg-primary bg-secondary hover:bg-muted absolute right-5 top-1/2 z-10 -translate-y-1/2 transform rounded-full p-2" />
          </Carousel>
          <h1 className="pb-2 pt-4 text-xl font-bold lg-pc:pb-3 lg-pc:pt-6 lg-pc:text-4xl mobile:hidden">
            Technologies Used
          </h1>
          <span className="flex flex-wrap mobile:hidden">
            <Shield
              svg={ReactIcon}
              text="React"
              textColor="#000000"
      ...
      <div className="bg-card mb-8 flex flex-row rounded-xl lg-pc:mb-14 lg-pc:text-3xl mobile:flex-col-reverse">
        <div className="m-6 flex flex-col pr-4 lg-pc:m-12">
          <div className="flex flex-row items-center justify-between pb-2 lg-pc:pb-3">
            <div className="flex w-full flex-row items-center pr-8">
              <Image
                ...
                className="h-10 w-10 lg-pc:h-20 lg-pc:w-20"
              />
              <h1 className="pl-2 text-2xl font-bold lg-pc:pl-6 lg-pc:text-5xl mobile:pr-4">
                Human Rights First’s Litigation Tracker
              </h1>
            </div>
          ...
          <p className="text-card-foreground">
            ...
            fragmented legal data, this platform now enables Human Rights First
            to manage and access litigation cases efficiently. My role in
            architecting the database and developing RESTful services using the
            T3 stack reinforces my commitment to using technology to drive
          ...
          <ul className="text-card-foreground list-disc pl-5">
            ...
            <li>
              Internal Dashboard where HRF staff can manage cases and create
              user accounts
            </li>
            <li>User Authentication</li>
      ...
      <div className="bg-card mb-8 flex flex-row rounded-xl lg-pc:mb-14 lg-pc:text-3xl mobile:flex-col-reverse">
        <div className="m-6 flex flex-col pr-4 lg-pc:m-12">
          <div className="flex flex-row items-center justify-between pb-2 lg-pc:pb-3">
            <div className="flex w-full flex-row items-center pr-8">
              <h1 className="text-2xl font-bold lg-pc:text-5xl">
                Fake Stack Overflow
              </h1>
            </div>

            <a
              href="https://github.com/jadenw2542/FakeStackOverflow"
              target="_blank"
              className="pr-4"
            >
              <Image
          ...
          <p className="text-card-foreground">
            Fake Stack Overflow is a mock web application for a popular
            question-and-answer website for programmers using the MERN Stack
            that features user authentication, voting system, key-word based
            question search This was my first full-stack project that led me to
